...
CELL_PROFILES: Dict[str, CellProfile] = {
    "hela": CellProfile(
        ...
        doubling_time_h=24.0, seeding_density_cell_cm2=1.5e4,
        ...
        reference_status="培养条件有来源；倍增及代谢速率为待校准先验",
        references=(ATCC_HELA, ACIDIFICATION_PAPER),
    ),
    "hek293": CellProfile(
        ...
        references=(ATCC_HEK293, HEK_BIOPROCESS_PAPER, ACIDIFICATION_PAPER),
    ),
    "a549": CellProfile(
